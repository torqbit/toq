  ...
  return (
    <section className={styles.tesimoinal__form__container}>
      <Form key={index} onFinish={handleTestimonial} form={form} requiredMark={false}>
        <ConfigForm
          input={
            <Form.Item noStyle name={"profile"} rules={[{ required: true, message: "Profile is required" }]}>
          ...
          <ConfigForm
            input={
              <Form.Item name={"name"} rules={[{ required: true, message: "Name is required" }]}>
                {<Input style={{ width: 250 }} placeholder={"Enter author name"} />}
              </Form.Item>
            }
            title={"Name"}
          ...
          <ConfigForm
            input={
              <Form.Item name={"designation"} rules={[{ required: true, message: "Designation is required" }]}>
                {<Input style={{ width: 250 }} placeholder={"Enter your designation"} />}
              </Form.Item>
            }
            title={"Designation"}
        ...
        <ConfigForm
          ...
          input={
            ...
            >
              <Input.TextArea
                style={{ marginBottom: 15, resize: "none" }}
                showCount
                maxLength={200}
                rows={3}
          ...
          title={"Description"}
          description={"Write the testimonial"}
          divider={false}
        />
      </Form>
    </section>

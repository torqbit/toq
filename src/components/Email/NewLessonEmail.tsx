          ...
          <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto    max-w-[465px]'>
            ...
            <Section className='px-[20px]'>
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]  '>
                A new lesson has been published in the course, <span style={{ fontWeight: "bold" }}>{configData.courseName}</span>
              </Text>

              <Text className='text-[#888] text-[14px] leading-[20px] font-bold text-black'>{configData.lessonName}</Text>

import { IEnrolmentEmailConfig, ILearningEnrollmentEmailConfig } from "@/lib/emailConfig";
...
interface IProps {
  configData: ILearningEnrollmentEmailConfig;
}

export const LearningEnrolmentEmail = ({ configData }: IProps) => {
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto    max-w-[465px]">
            ...
            <Section className="px-[20px]">
              ...
              <Text className="text-[#888] text-[14px] leading-[20px]">
                We&apos;re excited to let you know that you've successfully enrolled in {configData.learning.name}!
...
export default LearningEnrolmentEmail;

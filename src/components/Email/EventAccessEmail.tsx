          ...
          <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto    max-w-[465px]'>
            ...
            <Section className='px-[20px]'>
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]'>
                ...
                <span className='text-black text-[14px] '> {configData.eventName}</span> has been confirmed. Congratulations on taking this
                important step towards enhancing your skills.
              </Text>
              <Text className='text-[#888] text-[14px] leading-[20px]'>
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]'>Click the link below to open the location in google map</Text>

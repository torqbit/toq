          ...
          <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto    max-w-[465px]'>
            ...
            <Section className='px-[20px]'>
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]'>
                Welcome to the {`${site.brand?.name}`} Platform. we&apos;re excited to have you join our community. You can now excel in the
                field of software development, connect with fellow learners and help each other to move forward.
              </Text>

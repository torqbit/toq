...
import { Body, Container, Head, Heading, Hr, Html, Img, Link, Preview, Section, Text, Tailwind, Button } from "@react-email/components";
          ...
          <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto    max-w-[465px]'>
            ...
            <Section className='px-[20px]'>
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]  '>
                ...
                <span style={{ fontWeight: "bold" }}> {configData.submissionDate}</span> has been evaluated, with a score of{" "}
              ...
              <Text className='text-[#888] text-[14px] leading-[20px]'>To view the details of the evaluation, click the below button.</Text>

...
const SubscriptionExpireEmail = ({ configData }: IProps) => {
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto max-w-[465px]">
            ...
            <Section className="px-[20px]">
              ...
              <Text className="text-[#888] text-[14px] leading-[20px]">
                We wanted to let you know that your subscription to {`${configData.name}`} is set to expire on{" "}
                <strong>{configData.expirationDate}</strong>.
              </Text>

              <Text className="text-[#888] text-[14px] leading-[20px]">
                To continue enjoying uninterrupted access to our platform, please renew your subscription before the
                expiration date.
              </Text>
...
export default SubscriptionExpireEmail;
